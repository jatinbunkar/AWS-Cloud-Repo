...
<img width="895" alt="image" src="https://github.com/user-attachments/assets/5a46970d-3cba-4d59-9001-c8c7624fe16c">

<img width="835" alt="image" src="https://github.com/user-attachments/assets/f66bcc9f-36a5-4923-bcc5-164bb6e708b9">

<img width="830" alt="image" src="https://github.com/user-attachments/assets/542093f7-e7be-490a-a9c4-abc8f8b92b59">

<img width="830" alt="image" src="https://github.com/user-attachments/assets/f63ca1e0-0adb-4b51-9656-e66c984a1fc8">

<img width="894" alt="image" src="https://github.com/user-attachments/assets/d4416b66-aaa2-4e0e-ac1f-2b3623cb134e">
Skipping the Notification


<img width="1349" alt="image" src="https://github.com/user-attachments/assets/a32c78be-278b-4b24-b5ac-a69c8dc03cf9">

<img width="1344" alt="image" src="https://github.com/user-attachments/assets/f64e5877-1dee-467e-8b0a-7130390f54a2">

   - Once finished, navigate to **Load Balancers** to verify that the new load balancer is active. Open its **DNS Name** in the browser to see the HTTPD server test page.
...
Refer to the following links for additional information:
   ...
   - [Application Load Balancing](https://docs.aws.amazon.com/elasticloadbalancing/latest/application/create-application-load-balancer.html)
